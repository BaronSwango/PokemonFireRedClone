...
namespace PokemonFireRedClone
{
    public class WildPokemonFadeIn : BattleAnimation
    {
        ...
        // change constant speed to delta time
        ...
        public override bool Animate(GameTime gameTime)
        {
            ...
            int tintSpeed = (int) (0.5 * gameTime.ElapsedGameTime.TotalMilliseconds);
            ...
            if (ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.Tint != Color.White || ScreenManager.Instance.BattleScreen.BattleAssets.EnemyHPBarBackground.Position.X + enemySpeed < enemyHPDestinationX)
            {
                ...
                {
                    ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.Tint = new Color(ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.Tint.R + tintSpeed, ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.Tint.G + tintSpeed, ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.Tint.B + tintSpeed, 255);
                }
