...
namespace PokemonFireRedClone
{
    public class PokemonFaint : BattleAnimation
    {
        ...
        public override bool Animate(GameTime gameTime)
        {
            ...
            int playerSpeed = (int) (2 * gameTime.ElapsedGameTime.TotalMilliseconds);
            int enemySpeed = (int) (1.5 * gameTime.ElapsedGameTime.TotalMilliseconds);
            ...
            */
            ...
            if (player)
            {
                ...
                if (ScreenManager.Instance.BattleScreen.BattleAssets.PlayerPokemon.SourceRect.Height - playerSpeed > 0)
                {
                    ScreenManager.Instance.BattleScreen.BattleAssets.PlayerPokemon.SourceRect.Height -= playerSpeed;
            ...
            else
            {
                ...
                if (ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.SourceRect.Height - enemySpeed > 0)
                {
                    // ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.SourceRect.Height -= 12;
                    ScreenManager.Instance.BattleScreen.BattleAssets.EnemyPokemon.SourceRect.Height -= enemySpeed;
