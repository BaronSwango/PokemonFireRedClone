...
namespace PokemonFireRedClone
{
    public class EXPAnimation : BattleAnimation
    {
        ...
        public override bool Animate(GameTime gameTime)
        {
            ...
            if (ScreenManager.Instance.BattleScreen.BattleAssets.EXPBar.Scale.X + 0.01f < goalEXPScale || (ScreenManager.Instance.BattleScreen.BattleAssets.EXPBar.Scale.X + 0.01f < 1 && int.Parse(ScreenManager.Instance.BattleScreen.BattleAssets.PlayerPokemonAssets.Level.Text.Text[2..]) < goalLevel))
            {
