    ...
    public class BattleScreen : GameScreen
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (MenuManager.MenuName != "PokemonMenu")
            {
                ...
                if (TextBox.Page == 4 && BattleAssets.State != BattleAssets.BattleState.TRAINER_BATTLE_VICTORY && BattleAssets.State != BattleAssets.BattleState.WILD_BATTLE_ESCAPE && !MenuManager.IsLoaded)
                {
